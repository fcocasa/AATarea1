...
parser.add_argument("--gui", type=Boolean, default=False,
                    required=False, help="Show GUI (default: False)")
parser.add_argument("--cheat", type=Boolean, default=False,
                    required=False, help="Use a fixed list of actions (default: False)")
